class Communication::CommunicationsAdminController < ApplicationController
    ...
    def admin_student_communication
        temps = [];
        ...
        render 'communication/communications/admin_student_communication'
    end

    def admin_company_communication
        temps = [];
        # mail_type = 1111 => scotted , 2222 => direct message
        if params[:mail_type] == '1111' || params[:mail_type] == nil
        ...
        @conversation_list = Kaminari.paginate_array(@conversation_list).page(params[:page]).per(12)
        partner_new_communication_array(0)     
        render 'communication/communications/admin_company_communication'
    end
end