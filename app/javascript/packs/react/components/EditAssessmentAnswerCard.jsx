...
const EditAssessmentAnswerCard = ({
  answer,
  onClick,
  pageState,
  questionnaire,
}) => {
  const onClickHandler = (answer_id, questionnaire_answer) => {
    onClick && onClick(answer_id, questionnaire_answer);
  };
    ...
    <div className="col-lg-6">
      ...
      >
        ...
        <label
          ...
          onClick={() => onClickHandler(answer.id, answer.questionnaire_answer)}
        >
          <img
            src={
...
export default EditAssessmentAnswerCard;
