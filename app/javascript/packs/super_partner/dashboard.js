...
var companyCountListByEmployeeCountResult = companyCountListByEmployeeCount;
...
$(function() {
    /**begin::spu_search_datetime_picker */
    flatpickr("#search_date_picker", {
        ...
        onChange: function(selectedDates, dateStr, instance) {
            ...
            let url = BASE_URL + "super_partner_user/dashboard/index";
            window.location.assign(url + "?searchDate=" + $("#search_date").val());
        },
    });
    /**end::spu_search_datetime_picker */
});

var ctx = document
    .getElementById("spu_studentCompanyCountBarChart")
    .getContext("2d");
...
var myBarChart = new Chart(ctx, {
    ...
    options: {
        onClick: function(e) {
            let studenturl = BASE_URL + "super_partner_user/student_search";
            let companyurl = BASE_URL + "super_partner_user/company_manage/company_search";
